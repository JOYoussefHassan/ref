...
// ###########
/*
printf("_dta %_frS1 _dta _frS2 ...", _dta1, _dta2, ...);        ===> to print data
...
#include "/home/jo/Desktop/ref/c/Headers/jo_functions.h"
...
int main(void)
{
    ...
    FILE *file = fopen("/home/jo/Desktop/ref/c/Sources/log.txt", "a+");

    // header
    jo_str_repeat("#", 100, "\n");
    printf("%s", "#");
    jo_str_center("Welcome to PAYAMENT_TABLE.JO logging", ' ', 98, "#\n");
    jo_str_repeat("#", 100, "\n");
    printf("%s\n", DOCMNT);
    ...
    while (true)
    {
        ...
        switch (cliC[0])
        {
            ...
            case EDIT - ' ' :
                ...
                break;
            case VIEW - ' ' :
                for (int i = 0; i < jo_fil_lineLength(file); i++)
                {
                    char *str = jo_fil_linePrint(file, i);
                    printf("%s\n", str);
                    free(str);
                }
                break;
            case SEARCH - ' ' :
                printf("# %c\n", SEARCH - ' ');
                printf("%li", jo_str_int("-12345"));
                break;
            case SUMMATION - ' ' :
                printf("# %c\n", SUMMATION - ' ');
                printf("%s", jo_int_str(12345));
                break;
            case REMOVE - ' ' :
                printf("# %c\n", REMOVE - ' ');
                break;
        ...
        if (cliC[0] + cliC[1] == QUIT || cliC[0] == QUIT - ' ')
            break;
    }
}