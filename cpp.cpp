...
for (;;)
{
    _intStep_;
    _statement_
    _intEnd_;                                                                                                   ===> condition and inside this is (break)
};
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| datatypes |
-------------
...
[6] - decleration
    ...
    [6] - _datatype_* _var_ = _intAddress_
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| _formater_ |
--------------
...
| <string.h> |
--------------
[1] - strcat(_string_, _string_)                                                                                ===> concatenate strings
[2] - _string_.append(_string_)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| <array> |
-----------
[1] - array<_datatype_, _intLen_> _var_ = {_data, ...}
[2] - _array_.size()
[3] - _array_.fill(_data_)

[4] - _array_.front()                                                                                           ===> to get the first index
[5] - _array_.back()                                                                                            ===> to get the last index
[6] - _array_.at(_intIndex_)                                                                                    ===> to get value in array
[7] - _array_.empty()                                                                                           ===> check array is empty or not
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| _referance_ |
---------------
[1] - https://cpp.sh/                                                                                           ===> online compiler
